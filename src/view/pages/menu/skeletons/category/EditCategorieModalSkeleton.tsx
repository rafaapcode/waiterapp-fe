...
interface EditCategorieModalSkeletonProps {
  isVisible: boolean;
}

function EditCategorieModalSkeleton({ isVisible }: EditCategorieModalSkeletonProps) {
  if (!isVisible) {
    return null;
  }
  ...
  return (
    <Modal.Root size="sm" isVisible={isVisible}>
      <div className="p-6">
        ...
        <div className="w-full flex justify-between mt-4 animate-pulse">
...
export default EditCategorieModalSkeleton;
