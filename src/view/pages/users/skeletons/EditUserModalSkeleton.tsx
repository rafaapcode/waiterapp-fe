...
interface EditUserModalSkeletonProps {
  isVisible: boolean;
}

function EditUserModalSkeleton({ isVisible }: EditUserModalSkeletonProps) {
  if (!isVisible) {
    return null;
  }
        ...
        <div className="my-12 animate-pulse">
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="h-14 w-full bg-gray-300 rounded-md flex items-center pr-3">
                <div className="ml-auto h-6 w-6 bg-gray-400 rounded-full"></div>
              </div>
            </div>
...
export default EditUserModalSkeleton;
