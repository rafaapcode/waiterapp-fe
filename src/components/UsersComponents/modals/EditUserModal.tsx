  ...
  return (
    <Modal.Root size="sm" isVisible={isVisible}>
      <form action="" onSubmit={onSave}>
              ...
              <div className="flex gap-8">
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setRoleSelected({ waiter: false, adm: e.target.checked })
                    }
                    type="radio"
                    name="role"
                    id="tipo-adm"
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setRoleSelected({ adm: false, waiter: e.target.checked })
                    }
                    type="radio"
                    name="role"
                    id="tipo-garcom"
        ...
        <Modal.CustomFooter>
          <div className={`w-full flex ${roleSelected.waiter ? "justify-between" : "justify-end"}`}>
            {roleSelected.waiter && (
              <button
